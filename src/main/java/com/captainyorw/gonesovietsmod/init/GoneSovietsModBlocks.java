...
import com.captainyorw.gonesovietsmod.blocks.Cement;
import com.captainyorw.gonesovietsmod.blocks.Concrete50;
import com.captainyorw.gonesovietsmod.blocks.Bitumen;
import com.captainyorw.gonesovietsmod.blocks.ConcreteBlocks50;
//import com.captainyorw.gonesovietsmod.blocks.CrackedConcrete50;
...
@Mod.EventBusSubscriber(modid = GoneSovietsMod.MODID) 
 public class GoneSovietsModBlocks { 
 	...
 	static Block BITUMEN;
 	static Block BLOCKSCONCRETE50;
 	static Block CONCRETE50CRACKED;
 	...
 	public static void init() {
 		...
 		CEMENT = new Cement("cement", Material.ROCK);
 		CONCRETE50 = new Concrete50("concrete_50", Material.ROCK);
 		BITUMEN = new Bitumen("bitumen", Material.ROCK);
 		BLOCKSCONCRETE50 = new ConcreteBlocks50("concrete_blocks_50", Material.ROCK);
 		//CONCRETE50CRACKED = new CrackedConcrete50("concrete_50_cracked", Material.ROCK);
 	...
 	public static void registerBlocks(RegistryEvent.Register<Block> event) {
 		...
 		event.getRegistry().registerAll(CEMENT);
 		event.getRegistry().registerAll(CONCRETE50);
 		event.getRegistry().registerAll(BITUMEN);
 		event.getRegistry().registerAll(BLOCKSCONCRETE50);
 		//event.getRegistry().registerAll(CONCRETE50CRACKED);
 	...
 	public static void registerItemBlocks(RegistryEvent.Register<Item> event) { 
 		...
 		event.getRegistry().registerAll(new ItemBlock(CEMENT).setRegistryName(CEMENT.getRegistryName()));
 		event.getRegistry().registerAll(new ItemBlock(CONCRETE50).setRegistryName(CONCRETE50.getRegistryName()));
 		event.getRegistry().registerAll(new ItemBlock(BITUMEN).setRegistryName(BITUMEN.getRegistryName()));
 		event.getRegistry().registerAll(new ItemBlock(BLOCKSCONCRETE50).setRegistryName(BLOCKSCONCRETE50.getRegistryName()));
 		//event.getRegistry().registerAll(new ItemBlock(CONCRETE50CRACKED).setRegistryName(CONCRETE50CRACKED.getRegistryName()));
 	...
 	public static void registerRenders(ModelRegistryEvent event) { 
 		...
 		registerRender(Item.getItemFromBlock(CEMENT));
 		registerRender(Item.getItemFromBlock(CONCRETE50));
 		registerRender(Item.getItemFromBlock(BITUMEN));
 		registerRender(Item.getItemFromBlock(BLOCKSCONCRETE50));
 		//registerRender(Item.getItemFromBlock(CONCRETE50CRACKED));
