...
public class ConcreteStairsRight50 extends Block{
	//1:16 = 0.0625
	//(x1, y1, z1, x2, y2, z2)
	...
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_1 = new AxisAlignedBB(0, 0.0625 * 4, 0.0625 * 14.5, 0.0625 * 1, 0.0625 * 21, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_2 = new AxisAlignedBB(0.0625 * 2, 0.0625 * 4, 0.0625 * 14.5, 0.0625 * 3, 0.0625 * 23, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_3 = new AxisAlignedBB(0.0625 * 4, 0.0625 * 8, 0.0625 * 14.5, 0.0625 * 5, 0.0625 * 26, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_4 = new AxisAlignedBB(0.0625 * 6, 0.0625 * 8, 0.0625 * 14.5, 0.0625 * 7, 0.0625 * 28, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_5 = new AxisAlignedBB(0.0625 * 8, 0.0625 * 12, 0.0625 * 14.5, 0.0625 * 9, 0.0625 * 31, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_6 = new AxisAlignedBB(0.0625 * 10, 0.0625 * 12, 0.0625 * 14.5, 0.0625 * 11, 0.0625 * 33, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_7 = new AxisAlignedBB(0.0625 * 12, 0.0625 * 16, 0.0625 * 14.5, 0.0625 * 13, 0.0625 * 36, 0.0625 * 15.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_EAST_8 = new AxisAlignedBB(0.0625 * 14, 0.0625 * 16, 0.0625 * 14.5, 0.0625 * 15, 0.0625 * 38, 0.0625 * 15.5);
	...
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_1 = new AxisAlignedBB(0.0625 * 16, 0.0625 * 4, 0.0625 * 0.5, 0.0625 * 15, 0.0625 * 21, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_2 = new AxisAlignedBB(0.0625 * 14, 0.0625 * 4, 0.0625 * 0.5, 0.0625 * 13, 0.0625 * 23, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_3 = new AxisAlignedBB(0.0625 * 12, 0.0625 * 8, 0.0625 * 0.5, 0.0625 * 11, 0.0625 * 26, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_4 = new AxisAlignedBB(0.0625 * 10, 0.0625 * 8, 0.0625 * 0.5, 0.0625 * 9, 0.0625 * 28, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_5 = new AxisAlignedBB(0.0625 * 8, 0.0625 * 12, 0.0625 * 0.5, 0.0625 * 7, 0.0625 * 31, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_6 = new AxisAlignedBB(0.0625 * 6, 0.0625 * 12, 0.0625 * 0.5, 0.0625 * 5, 0.0625 * 33, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_7 = new AxisAlignedBB(0.0625 * 4, 0.0625 * 16, 0.0625 * 0.5, 0.0625 * 3, 0.0625 * 36, 0.0625 * 1.5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_WEST_8 = new AxisAlignedBB(0.0625 * 2, 0.0625 * 16, 0.0625 * 0.5, 0.0625 * 1, 0.0625 * 38, 0.0625 * 1.5);
	...
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_1 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 4, 0.0625 * 16, 0.0625 * 15.5, 0.0625 * 21, 0.0625 * 15);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_2 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 4, 0.0625 * 14, 0.0625 * 15.5, 0.0625 * 23, 0.0625 * 13);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_3 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 8, 0.0625 * 12, 0.0625 * 15.5, 0.0625 * 26, 0.0625 * 11);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_4 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 8, 0.0625 * 10, 0.0625 * 15.5, 0.0625 * 28, 0.0625 * 9);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_5 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 12, 0.0625 * 8, 0.0625 * 15.5, 0.0625 * 31, 0.0625 * 7);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_6 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 12, 0.0625 * 6, 0.0625 * 15.5, 0.0625 * 33, 0.0625 * 5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_7 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 16, 0.0625 * 4, 0.0625 * 15.5, 0.0625 * 36, 0.0625 * 3);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_NORTH_8 = new AxisAlignedBB(0.0625 * 14.5, 0.0625 * 16, 0.0625 * 2, 0.0625 * 15.5, 0.0625 * 38, 0.0625 * 1);
	...
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_1 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 4, 0.0625 * 0, 0.0625 * 0.5, 0.0625 * 21, 0.0625 * 1);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_2 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 4, 0.0625 * 2, 0.0625 * 0.5, 0.0625 * 23, 0.0625 * 3);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_3 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 8, 0.0625 * 4, 0.0625 * 0.5, 0.0625 * 26, 0.0625 * 5);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_4 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 8, 0.0625 * 6, 0.0625 * 0.5, 0.0625 * 28, 0.0625 * 7);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_5 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 12, 0.0625 * 8, 0.0625 * 0.5, 0.0625 * 31, 0.0625 * 9);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_6 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 12, 0.0625 * 10, 0.0625 * 0.5, 0.0625 * 33, 0.0625 * 11);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_7 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 16, 0.0625 * 12, 0.0625 * 0.5, 0.0625 * 36, 0.0625 * 13);
	public static final AxisAlignedBB COLLISION_BOX_RAILING_SOUTH_8 = new AxisAlignedBB(0.0625 * 1.5, 0.0625 * 16, 0.0625 * 14, 0.0625 * 0.5, 0.0625 * 38, 0.0625 * 15);
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public ConcreteStairsRight50(String name, Material material) {
		super(material); 
